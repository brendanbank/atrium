...
| [0.14.1](https://github.com/Brendan-Bank/atrium/releases/tag/v0.14.1) | unchanged | — (fix: `__ATRIUM_VERSION__` actually populates on the published image; v0.14.0 returned `"unknown"` because `atrium-backend` had no dist-info in the runtime venv — see #57) | — | — |
